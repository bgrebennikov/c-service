...
set CLASSPATH=%APP_HOME%\lib\c-service-all.jar

@rem Execute c-service
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %C_SERVICE_OPTS%  -jar "%CLASSPATH%" %CMD_LINE_ARGS%
...
if  not "" == "%C_SERVICE_EXIT_CONSOLE%" exit 1
exit /b 1
